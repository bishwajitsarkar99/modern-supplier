      ...
      <SidebarContent className={twMerge(
        ...
        <SidebarMenuButton 
          ...
          <Link href={data.home.url} className={twMerge(
            ...
            <data.home.icon className="ms-2 size-4 text-gray-500 group-hover:text-orange-400 group-hover:transform-3d group-hover:transition group-hover:duration-200" />
